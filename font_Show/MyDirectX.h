...
// new prototype functions added 
void Sprite_Draw_Frame(LPDIRECT3DTEXTURE9 image, int x, int y,
	int width, int height, int frame = 0, int colums = 1,
	float rotaion = 0.0f, float scaling = 1.0f, D3DCOLOR color = D3DCOLOR_XRGB(255, 255, 255)
);

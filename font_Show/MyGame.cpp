...
void Game_Run(HWND window)
{
	...
	if (d3ddev->BeginScene())
	{
		...
		FontPrint(fontGaramond36, 60, 100, "The text can be printed in any color like this magental",
			D3DCOLOR_XRGB(255, 0, 255));
		FontPrint(fontTimesNewRoman40, 60, 150, "Or how about bright green instead",
		...
		fontTimesNewRoman40->DrawTextA(spriteobj, text.c_str(), text.length(), &rect, DT_WORDBREAK, white);

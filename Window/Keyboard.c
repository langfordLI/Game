...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    TCHAR szBuffer[129], szKeyName[32];
    ...
    case WM_DISPLAYCHANGE:
        ...
        // Get Character size for fixed-pithc font
        ...
        pmsg = (PMSG)malloc(sizeof(MSG) * cLinesMax); // a line alloc a message
        cLines = 0;
    ...
    case WM_SIZE:
        ...
        rectScroll.bottom = cyChar * (cyClient / cyChar); // change to int
    ...
    case WM_PAINT:
        ...
        // if not set transparent, the next string will erease front string
